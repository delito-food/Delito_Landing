...
const socialLinks = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/delitoeats?igsh=eWZ2cXg5OHJ5bzBs",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61560328274744#",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <>
      <footer className="bg-white border-t border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="space-y-5 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm text-text-muted leading-relaxed">
                Hathras ka apna food delivery app. Ghar baithe mangwao apni
            ...
            <div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <a
                  href="https://wa.me/917417548430"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-green-mid hover:text-green-dark transition-colors duration-200 font-medium flex items-center gap-1.5"
                >
        ...
        <div className="border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-wrap items-center justify-center gap-x-6 gap-y-1 text-[11px] text-text-muted/70">
            <span>
              <strong className="text-text-muted">GSTIN:</strong>{" "}
              09CAMPV6339R1ZD
            </span>
            <span className="hidden sm:inline text-gray-300">|</span>
            <span>
              <strong className="text-text-muted">FSSAI:</strong>{" "}
              22726884000160
            </span>
          </div>
        </div>
